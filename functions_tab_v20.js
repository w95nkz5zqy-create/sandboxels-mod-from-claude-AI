                ...
                if (func.type === 'passable') {
                    ...
                    for (var i = func.extensions.length - 1; i >= 0; i--) {
                        ...
                        if (pixelMap[ext.x] && pixelMap[ext.x][ext.y]) {
                            var elem = pixelMap[ext.x][ext.y].element;
                    ...
                    if (func.active && func.value > 0) {
                        ...
                        console.log('Extending', dist, 'pixels (max:', maxDist, 'value:', func.value + ')');
                        ...
                        console.log('Created', func.extensions.length, 'extensions');
                    }
                }
            });
        }
