...
(function() {
    ...
    function loadMod() {
        ...
        console.log('====================================');
        console.log('FISSION MOD v43 LOADED!');
        console.log('Changes:');
        console.log('- Max temp capped at 1600°C');
        console.log('- NO barium/xenon elements (removed)');
        console.log('- NO barium/xenon absorbers (removed)');
        console.log('- Neutrons pass through water');
        console.log('- Explosion-resistant uranium/absorbers/rods');
        console.log('====================================');
    }
})();
