...
elements.uranium_235 = {
    ...
    tick: function(pixel) {
        // Check if uranium was recently heated by neutron collision
        if (pixel.temp > 500) {
            // Spawn 2 additional neutrons (reaction already made 1)
            for (var i = 0; i < 2; i++) {
            ...
            // Occasionally create fission products
            if (Math.random() < 0.2) {
