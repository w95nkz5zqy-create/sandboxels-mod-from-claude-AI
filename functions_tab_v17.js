        ...
        function exec(func) {
            ...
            func.pixels.forEach(function(pd) {
                ...
                if (func.type === 'passable') {
                    ...
                    func.extensions.forEach(function(e) {
                    ...
                    if (func.active) {
                        var dist = func.control === 'slider' ? Math.floor(5 * (func.value / 100)) : 5;
                        ...
                        for (var i = 1; i <= dist; i++) {
                            ...
                            if (isEmpty(ex, ey)) {
                                var en = p.element + '_ext';
                                if (!elements[en]) {
                                    elements[en] = {
                                        color: elements[p.element].color,
                                        behavior: behaviors.WALL,
                                        category: 'special',
                                        state: 'solid'
                                    };
                                }
                                createPixel(en, ex, ey);
